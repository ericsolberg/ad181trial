...
annotate customer_loyaltySrv.Customers with @UI.HeaderInfo: { TypeName: 'Customer', TypeNamePlural: 'Customers' };
annotate customer_loyaltySrv.Customers with @UI.DataPoint #name: {
  Value: name,
  Title: 'Name',
};
annotate customer_loyaltySrv.Customers with @UI.DataPoint #email: {
  Value: email,
  Title: 'Email',
};
annotate customer_loyaltySrv.Customers with @UI.DataPoint #customerNumber: {
...
annotate customer_loyaltySrv.Customers with @UI.HeaderFacets: [
